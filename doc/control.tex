...
\begin{equation*}
    ...
    \begin{bmatrix}
        -\sin(\theta) & \cos(\theta) & L \\
        -\sin(\theta + 120^\circ) & \cos(\theta + 120^\circ) & L \\
        -\sin(\theta + 240^\circ) & \cos(\theta + 240^\circ) & L
    \end{bmatrix}^{-1}
    \begin{bmatrix}
        v_1 \\
        v_2 \\
...
{\justify
    \hspace{0.5cm} El modelo también se puede representar como
...
\begin{equation*}
    ...
    \begin{bmatrix}
        -\sin(\theta) & \cos(\theta) & L \\
        -\sin(\theta + \frac{2\pi}{3}) & \cos(\theta + \frac{2\pi}{3}) & L \\
        -\sin(\theta + \frac{4\pi}{3}) & \cos(\theta + \frac{4\pi}{3}) & L
    \end{bmatrix}^{-1}
    \begin{bmatrix}
        v_1 \\
        v_2 \\
